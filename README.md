...
Use the same interpreter that installed dependencies (activated venv or `.venv/bin/python`) so imports match:
...
- **Akshat Singh** — project author & maintainer ([ExamGuradAi](https://github.com/akshat-collab/ExamGuradAi))
